...
By [exceedance probabilities] we refer to the probably that  values of a [randon] variable, $Y$, will exceed a certain pre specified value $c$, that is  $Pr[Y \ge c.$
