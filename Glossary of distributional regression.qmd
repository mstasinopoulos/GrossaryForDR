...
By [base learner] we mean a individual [model] in the [ensemble].
...
[CI] is and abbreviation for [confidence intervals].
...
By  [diversity] we mean the qualitative differences between [model]s/[base learners]. 
...
A [categorical variable] is a [vector] in the data which take only restriced values.  Those variables are called [factor]s in [statistical analysis]  
...
A [prediction interval] is a [confidence interval] intended to demonstrate the uncentaintly about future values of a quantity of interest. 
